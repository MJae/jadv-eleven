...
export async function getGitLastUpdatedTimeStamp(filePath) {
	try {
		...
		console.log( "Error git last modified date", e );
		// do nothing
	}
}

export async function getGitFirstAddedTimeStamp(filePath) {
	try {
		let timestamp = await spawnAsync(
			"git",
			// Formats https://www.git-scm.com/docs/git-log#_pretty_formats
		...
		console.log( "Error git created date", e );
		// do nothing
	}
}
